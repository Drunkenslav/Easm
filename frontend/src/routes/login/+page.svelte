...
<div class="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
	...
	<div class="max-w-md w-full relative z-10 fade-in">
		...
		<div class="text-center mb-8">
			<div class="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-600 shadow-2xl shadow-blue-500/50 mb-4 transform hover:scale-110 transition-transform duration-300">
			...
			<p class="text-gray-600 font-medium">External Attack Surface Management</p>
		</div>
		...
		<div class="glass rounded-3xl p-8 shadow-2xl">
			...
			{#if error}
				<div class="mb-4 p-4 bg-red-50/80 backdrop-blur-sm border border-red-200 rounded-xl text-sm text-red-800">
